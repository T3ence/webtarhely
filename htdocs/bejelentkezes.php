...
<head>
    <meta charset="UTF-8">
    <title>Bejelentkezés - Webtárhely</title>
...
<div class="w3-container w3-light-grey" style="padding:128px 16px" id="Contact">
  <h3 class="w3-center">Bejelentkezés</h3>
  <p class="w3-center w3-large">Jelentkezz be!</p>
    <?php if (isset($jelszo_error)): ?>
        <p class="w3-center w3-large" style="color: red"><?php echo $jelszo_error?></p>
    <?php endif ?>

  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">

    <div class="w3-col l4 m6 w3-margin-bottom" style="align-content: center; text-align: center">
      <div class="w3-card">
        <div class="w3-container ">
          <form method="post" action="bejelentkezes.php" target="">
            <p><input class="w3-input w3-border" type="text" placeholder="e-mail" required name="email"></p>
            <p><input class="w3-input w3-border" type="text" placeholder="Jelszó" required name="password"></p>
            <p>
              <button class="w3-button w3-black" name="login" type="submit">
                <i class="fa fa-arrow-up w3-margin-right"></i> Bejelentkezés
              </button>
            </p>
          </form>
        </div>
      ...
      <div class="w3-col l5 m6 w3-margin-bottom">
          <div class="w3-card">
              <img src="./imgs/login.jpg" alt="Adatbázis" style="width:100%">
          </div>
      </div>
